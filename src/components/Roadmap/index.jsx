            ...
            >
              ...
              <li className="timeline-item bg-white rounded ml-3 p-4 shadow">
                ...
                <ul style={{ paddingLeft: "15px", marginTop: "10px" }}>
                  <li>
                    <p className="text-small font-weight-bold">
                      1,000 discord (10 Beez Giveaway)/3,000 discord (10 Beez Giveaway)/
                      5,000 discord (10 Beez Giveaway).
                    </p>
                  </li>
                  <li>
                    <p className="text-small font-weight-bold">
              ...
              <li className="timeline-item bg-white rounded ml-3 p-4 shadow">
                ...
                <ul style={{ paddingLeft: "15px", marginTop: "10px" }}>
                  ...
                  <li>
                    ...
                    <li>
                      <p className="text-small font-weight-bold">
                        6,000 discord (10 Beez Giveaway)/8,500 discord (10 Beez Giveaway)/10,000
                        discord (10 Beez Giveaway).
                      </p>
                    </li>
                    <li>
                      <p className="text-small font-weight-bold">
                        100% MINT OF SECOND MINT- FORM OF COMMUNITY Wallet.
                      </p>
                    </li>
                    <li>
                      <p className="text-small font-weight-bold">
              ...
              <li className="timeline-item bg-white rounded ml-3 p-4 shadow">
                ...
                <ul style={{ paddingLeft: "15px", marginTop: "10px" }}>
                  ...
                  <li>
                    <p className="text-small font-weight-bold">
                      Discord process of deciding how to spend Community Wallet.
                    </p>
                    <li>
                      <p className="text-small font-weight-bold">
